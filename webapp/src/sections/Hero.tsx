...
import { Clock, ShieldCheck, Wrench, PhoneCall, ChevronDown } from 'lucide-react';
    ...
    <section id="hero" className="relative min-h-screen pt-24 bg-background overflow-hidden flex items-center">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            <button
              onClick={() => window.open('https://wa.me/97335081527', '_blank')}
              className="inline-flex items-center justify-center gap-2.5 h-14 px-8 text-lg font-semibold text-white rounded-md bg-[#25D366] hover:bg-[#1ebe5d] active:bg-[#17a350] transition-colors duration-200 shadow-sm cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
